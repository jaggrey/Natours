...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiamFnZ3JleSIsImEiOiJjazdhY2RxNWgxMnZ3M2xwNmJ3OW1zNjFuIn0.FUPlewAssrQryoabRMih3A';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/jaggrey/ck7acvg9e0cws1iry43zk4tj2',
    scrollZoom: false // center: [-118.114652, 34.132162],
    // zoom: 4,
    // interactive: false
    ...
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            res = _context2.sent;
            if (res.data.status = 'success') location.reload(true); // location.reload reloads the page from the server and not from browser cache
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            res = _context.sent;
            res.data.status && (0, _alerts.showAlert)('success', "".concat(type.toUpperCase(), " updated successfully!"));
            _context.next = 11;
            break;
...
var stripe = Stripe('pk_test_icmN2xdJiV1noOcDQru8aPXv004zafBxpS');
...
logoutBtn && logoutBtn.addEventListener('click', _login.logout);
